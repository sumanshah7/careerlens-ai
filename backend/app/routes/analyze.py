...
async def analyze_resume(
    ...
    try:
        ...
        if result_dict and (not result_dict.get("areas_for_growth") or len(result_dict.get("areas_for_growth", [])) == 0):
            ...
            # ALWAYS regenerate using actual skills comparison to ensure it's dynamic
            print(f"[Analyze] Regenerating areas_for_growth using actual skills comparison to ensure it's dynamic, hash={debug_hash}")
